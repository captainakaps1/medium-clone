...
function Header() {
  return (
    <header className='flex justify-between px-5 h-16 border border-b shadow shadow-outline fixed w-full bg-white'>
        <div className='flex items-center space-x-5'>
          <Link href="/">
            <img className='w-44 object-contain cursor-pointer' src='https://links.papareact.com/yvf' alt='image'/>
          </Link>
